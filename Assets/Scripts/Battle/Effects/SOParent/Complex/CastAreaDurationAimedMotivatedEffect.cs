...
public class CastAreaDurationAimedMotivatedEffect : EffectInfoBase, IAreaEffect, ISearchAbilityEffect, ISearchStateEffect, IDurationEffect,IMotivatedEffect, IThresholdEffect
{
