...
public class BattleFormulaInfoEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        calculationTypeProp = serializedObject.FindProperty("calculationType");
    ...
    public override void OnInspectorGUI()
    {
        ...
        descriptionProp.stringValue = EditorGUILayout.TextArea(descriptionProp.stringValue, GUILayout.ExpandHeight(true));
